...
• After dispatch, use the return process (within 7 days of delivery).
• Eligible refunds are processed via Razorpay to the original payment method.
• UPI/Wallets: 3–5 business days | Cards/Net-banking: 5–7 business days | COD: 7–10 business days.

Full policy: /refund-policy
Contact: support@exnshop.in | 6399376602`;
