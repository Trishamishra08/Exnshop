    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-neutral-200/80 shadow-sm">
        <div>
          <div className="flex items-center gap-2 text-xs text-neutral-500 mb-1">
            ...
            <span>/</span>
            <span className="text-indigo-600 font-medium">Shipped Orders</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <button
            onClick={() => {
              setCurrentPage(1);
              setLoading(true);
              getOrdersByStatus('Shipped', { page: 1, limit: parseInt(entriesPerPage), channel: mode })
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-2xl border border-neutral-200/80 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-neutral-500">Shipped Orders</p>
                ...
                <tr>
                  <td colSpan={9} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center gap-2">
                      ...
                      <p className="text-sm font-medium text-neutral-500">Loading shipped orders...</p>
                    </div>
                  </td>
                </tr>
              ) : error ? (
                ...
                <tr>
                  <td colSpan={9} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center gap-2 text-neutral-400">
                      ...
                      <p className="text-base font-semibold text-neutral-700">No Shipped Orders Found</p>
                      <p className="text-xs text-neutral-500">No shipped orders match your active filter parameters.</p>
