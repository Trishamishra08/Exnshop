...
export default function AdminPendingOrders() {
  ...
  const stats = useMemo(() => {
    ...
    const unassignedCount = orders.filter(o => o.deliveryBoyStatus !== 'Assigned').length;
    const assignedCount = orders.filter(o => o.deliveryBoyStatus === 'Assigned').length;
    return { totalCount, totalAmount, unassignedCount, assignedCount };
  }, [orders]);
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-neutral-200/80 shadow-sm">
        <div>
          <div className="flex items-center gap-2 text-xs text-neutral-500 mb-1">
            ...
            <span>/</span>
            <span className="text-amber-600 font-medium">Pending Orders</span>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-4 rounded-2xl border border-neutral-200/80 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-neutral-500">Unassigned Delivery</p>
            <h3 className="text-xl font-extrabold text-neutral-900">{stats.unassignedCount}</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-4 rounded-2xl border border-neutral-200/80 shadow-sm flex items-center gap-4">
          ...
          <div>
            <p className="text-xs font-medium text-neutral-500">Assigned Delivery</p>
            <h3 className="text-xl font-extrabold text-neutral-900">{stats.assignedCount}</h3>
          </div>
        </div>
      </div>
                ...
                <tr>
                  <td colSpan={9} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center gap-2">
                      ...
                      <p className="text-sm font-medium text-neutral-500">Loading pending orders...</p>
                    </div>
                  </td>
                </tr>
              ) : error ? (
                ...
                <tr>
                  <td colSpan={9} className="px-6 py-12 text-center">
                    <div className="flex flex-col items-center justify-center gap-2 text-neutral-400">
                      ...
                      <p className="text-base font-semibold text-neutral-700">No Pending Orders Found</p>
                      <p className="text-xs text-neutral-500">No pending orders match your active filter parameters.</p>
                      ...
                      <td className="px-4 py-3.5 text-center whitespace-nowrap">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            title={order.deliveryBoyStatus === 'Assigned' ? 'Re-assign delivery partner' : 'Assign delivery partner'}
                          >
                          ...
                          <Link to={`/admin/orders/${order._id}`}>
                            <button
                              className="p-1.5 text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-lg transition-all border border-emerald-200"
