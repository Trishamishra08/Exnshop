...
async function insertAllSections() {
  ...
  for (const def of sectionDefs) {
    ...
    console.log('✅ Configured Section:', def.title, '| Subcategories count:', subIds.length);
  }

  await mongoose.disconnect();
  console.log('\n🎉 ALL 4 SECTIONS POPULATED SUCCESSFULLY!');
}

insertAllSections().catch(console.error);
